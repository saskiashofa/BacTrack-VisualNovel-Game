...
screen about():
    ...
    vbox:
        ...
        text _("Made with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\nBacTrack adalah game edukasi berbentuk visual novel yang membahas materi virus. Game ini mengajak pemain memahami struktur virus, replikasi virus, peranan virus, penularan, dan pencegahannya melalui alur cerita tentang wabah misterius.\n\nDosen Pengampu: Ir. Nuur Wachid Abdul Majid, M.Pd., IPM\nAsisten Dosen: Reisa Aulia Sodikin, S.Pd\nMitra: Hanifah Nur Alfiyyah, S.Pd., Gr")
    ...
    vbox:
        ...
        hbox:
            ...
            vbox:
                ...
                text _("Developer:")
                text _("Saskia Shofawatunnisa\n2400686\nPendidikan Sistem dan Teknologi Informasi\n@shofaaanw")
        text _("\nCredits:")
        text _("Aset visual, karakter, background, audio, dan elemen pendukung dalam game ini menggunakan free assets yang tersedia secara publik dan disesuaikan untuk kebutuhan game BacTrack.")
        text _("Template GUI dibuat oleh Skolaztika.")
...
screen map_screen():
    ...
    imagebutton:
        ...
        xsize 264
        ysize 66
        action [Play("sound", "audio/klik.ogg"), Jump("lab")]
    ...
    if kebun_unlocked:
        imagebutton:
            ...
            xsize 322
            ysize 66
            action [Play("sound", "audio/klik.ogg"), Jump("kebun")]
    else:
        add Solid("#00000080") xpos 806 ypos 693 xsize 322 ysize 66
    ...
    if rumah_unlocked:
        imagebutton:
            ...
            xsize 250
            ysize 66
            action [Play("sound", "audio/klik.ogg"), Jump("rumah")]
    else:
        add Solid("#00000080") xpos 1452 ypos 793 xsize 250 ysize 66

screen menu():

    imagebutton:
        idle Transform("images/bg/btnmenu.png", zoom=1.3)
        hover Transform("images/bg/btnklikmenu.png", zoom=1.34)

        xpos 800
        ypos 454

        action [Play("sound", "audio/klik.ogg"), Jump("scene")]

screen soal_nomor_gambar(pertanyaan, gambar, zoom_gambar=1.0):
...
screen soal_gambar_teks(pertanyaan, gambar, opsi_a, opsi_b, opsi_c, zoom_gambar=0.6):
...
screen kuis():
    ...
    vbox:
        ...
        textbutton "Lanjut":
                xalign 0.5
                action [Play("sound", "audio/klik.ogg"), Return()]

screen hasil_quiz(score, total, minimum, habis=False):
    ...
    frame:
        ...
        vbox:
            ...
            if score >= minimum:
                ...
                text "Pemahamanmu cukup untuk melanjutkan perjalanan.":
                    xalign 0.5
                    text_align 0.5
                    size 30
                    color "#F6E3CB"
                ...
                if habis:
                    ...
                    text "Pemahamanmu belum cukup untuk mengendalikan wabah.":
                        xalign 0.5
                        text_align 0.5
                        size 30
                        color "#F6E3CB"
                    ...
                    text "Pelajari kembali materi sebelum mencoba lagi.":
                        xalign 0.5
                        text_align 0.5
                        size 30
                        color "#F6E3CB"
            ...
            textbutton "LANJUT":
                ...
                text_size 24
                text_color "#F6E3CB"
                text_hover_color "#150C0C"
                background Solid("#4F0803")
                hover_background Solid("#C5D83F")
                padding (44, 10)
                action [Play("sound", "audio/klik.ogg"), Return()]